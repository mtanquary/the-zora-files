...
**The show in one sentence:** Every episode is a scored expedition for the perfect sunrise. Every dawn, a new chance to discover something.

**Geographic scope:** The show is global by intent. Arizona is the practical home base for early seasons — that's where the host lives, and that's where the weekly cadence is easiest to sustain — but no location, biome, or geography is part of the brand identity. The distinction matters: individual episode titles, captions, and metadata should still name the actual location ("Horton Creek, AZ", "Mount Rainier, WA", "Skye, Scotland") as a factual reference; channel-level brand copy — bios, taglines, channel descriptions — should not. Every sunrise belongs to someone. This is the record of one person's pursuit of the perfect one, wherever it leads. Travel episodes are expeditions away from home base, not a pivot to generic travel content.
...
- **2026-05-28** — Brand voice refinement on the eve of S01E01 launch. Two prior brand elements retired: (1) "the desert doesn't care about your plan" — replaced by **"every sunrise, a new expedition"** as the secondary tagline alongside the core line "the true beauty in every sunrise is the journey you took to witness it"; (2) "Arizona-based, globally aimed" framing in bios — dropped because no location is part of the brand identity. Important nuance: Arizona is still named factually as the location of individual expeditions (e.g., "Horton Creek, AZ") — the change is about brand identity, not factual references. Updates the 2026-03 decision: AZ is still home base in practice, just not a brand attribute.